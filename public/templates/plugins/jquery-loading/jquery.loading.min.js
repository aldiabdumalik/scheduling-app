            ...
            (r.defaults = {
                ...
                o.a.extend(r.prototype, {
                    ...
                    createOverlay: function () {
                        var t = o()(`<div class="loading-overlay loading-theme-${this.settings.theme}">
                    ...
                    resize: function () {
                        ...
                        this.settings.fullPage && ((n = "100%"), (e = "100%")),
                            this.overlay.css({ position: this.settings.fullPage ? "fixed" : "absolute", zIndex: this.calcZIndex(), top: t.offset().top, left: t.offset().left, width: e, height: n });
                    },
                    start: function () {
            ...
            (o.a.fn.loading = function (t) {
                return this.each(function () {
                    ...
                    e
                        ...
                        : (void 0 !== t && "object" != typeof t && "start" !== t && "toggle" !== t) || o.a.data(this, s, new r(o()(this), t));
                });
            }),
                (o.a.fn.Loading = function (t) {
                    var e = o()(this).data(s);
